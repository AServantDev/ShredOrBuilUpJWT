...
//    }
    ...
    public User save(UserDto user) {
		...
		if(newUser.getGender().equals("feminin")) {
			...
			double kcalPerDay = (9.740*newUser.getWeight()) + (172.9 * newUser.getHeigth()) - (4.737 * newUser.getAge()) + 667.051;
...
//			MB (Homme) = 13,707∗Poids (kg) + 492,3∗Taille (m)−6,673∗Age (an) + 77,607
			double kcalPerDay = (13.707*newUser.getWeight()) + (492.3 * newUser.getHeigth()) - (6.673 * newUser.getAge()) + 77.607;
			newUser.setKcalPerDay(kcalPerDay * newUser.getCoefSportif());
